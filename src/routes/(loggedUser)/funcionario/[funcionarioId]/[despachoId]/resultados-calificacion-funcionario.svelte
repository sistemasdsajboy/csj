...
<h2 class="bold pt-8 text-center text-2xl font-bold text-slate-800">
...
<div class="overflow-x-auto">
	<table class="w-full table-auto border-collapse">
		...
		<tbody>
			{#each c.consolidadoGarantias as fila}
				<tr class="border-b border-gray-200 dark:border-gray-700">
					<td class="text-nowrap px-2 text-gray-900 dark:text-gray-100">
						{c.funcionarios.find((f) => f.id === fila.funcionarioId)?.nombre}
					</td>
...
<div class="overflow-x-auto">
	<table class="w-full table-auto border-collapse">
		...
		<tbody>
			{#each c.consolidadoEscrito as fila}
				<tr class="border-b border-gray-200 dark:border-gray-700">
					<td class="text-nowrap px-2 text-gray-900 dark:text-gray-100">
						{c.funcionarios.find((f) => f.id === fila.funcionarioId)?.nombre}
					</td>
...
<h3 class="bold pt-8 text-2xl font-bold text-slate-800">Otros asuntos</h3>
<div class="overflow-x-auto">
	<table class="w-full table-auto border-collapse">
		<thead>
			<tr class="bg-gray-100 dark:bg-gray-800">
		...
		<tbody>
			{#each c.consolidadoOtros as fila}
				<tr class="border-b border-gray-200 dark:border-gray-700">
					<td class="text-nowrap px-2 text-gray-900 dark:text-gray-100">
						{c.funcionarios.find((f) => f.id === fila.funcionarioId)?.nombre}
					</td>
